    ...
    */
    protected function lead_gen() {
		...
		try
		{
			...
			// $app_query = mysql_query("SELECT stripe_secret_key, stripe_publishable_key,twilio_sid,twilio_auth_token FROM app_keys WHERE 1=1");
			...
			//mysql_query("INSERT INTO questionnaire(ip, email, phone, name, timestamp, token,has_submitted) VALUES('".$_SERVER['REMOTE_ADDR']."', '".$posted_email."', '".$posted_phone."', '".$posted_name."', '".time()."', '".$tokenid."',1)");
				...
				//COUNT ALL SMS SENT
				if($sms_qty != 0){
					\Stripe\Stripe::setApiKey("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"); //change to your live key
