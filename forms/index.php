                    ...
                    <div class="col-xs-12 col-sm-6">	
                        <form class="section_loginForm">
                            ...
                            <div class="input-group ptb-10">
                                ...
                                <input type="email" class="form-control" data-api='email' name="email" placeholder="What's your email?">
                            </div>
                             <div class="input-group ptb-10">
                                <span class="input-group-addon"><i class="ti-email"></i></span>
                                <input type="email" class="form-control" data-api='phone' name="phone" placeholder="Phone number goes here.">
                            </div>
                             <div class="input-group ptb-10">
                                <span class="input-group-addon"><i class="ti-email"></i></span>
                                <input type="email" class="form-control" data-api='zipcode' name="zipcode" placeholder="What's your zip code?">
                                <input type="hidden" data-api='leadTypes' value="contactform"/>
                            </div>
                            <div class="ptb-20">
                                <input type="button" value="Contact Us!" id="btn" data-api='lead-gen' name="button" class="btn btn-lg btn-theme-primary btn-block" type="submit">
                            </div>
