                ...
                <div class="row section_row-sm-offset-3">
                    <div class="col-xs-12 col-sm-6">	
                        <form class="section_loginForm">
                            ...
                            <div class="input-group ptb-10">
                                <span class="input-group-addon"><i class="ti-email"></i></span>
                                <input maxlength="160" type="text" class="form-control" data-api='notes' name="notes" placeholder="Notes go here maximum of 160 characters.">
                            </div>
                            <div class="input-group ptb-10">
                                <span class="input-group-addon"><i class="ti-email"></i></span>
                            ...
                            <script type="text/javascript">
                                ...
                                //alert("Sending lead, please wait... Redirecting...");
                                    }
                            </script>
                            <div class="ptb-20">
                                <input type="button" id="btn" data-api='lead-gen' name="button" class="btn btn-lg btn-theme-primary btn-block" value="Submit Lead Manually" type="submit" onclick="disableButton(this)">
                            </div>
