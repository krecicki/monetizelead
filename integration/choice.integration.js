(function(){
	...
	window.addEventListener('load', 
	  function() { 
		...
		var notes = jQuery("[data-api='notes']");	
		...
		if(btn)
		{
			btn.click(function(){
				...
				var data = {
						action: 'lead_gen', 
						leadData: {'apiKey': apikey.val(),'name':name.val(),'email':email.val(),'phone':phone.val(),'zipcode':zipcode.val(),'lead_types':lead_types.val(),'notes':notes.val()}
