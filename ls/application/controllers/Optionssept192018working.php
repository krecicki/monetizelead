...
class Options extends CI_Controller 
{
	...
	public function index() 
	{
		...
		$this->template->loadExternal(
			...
			.base_url().'scripts/custom/jscolor.js" /></script>'
		);
	...
	public function save() 
	{
		...
		$lead_rate_limit = $this->common->nohtml($this->input->post("lead_rate_limit"));
		...
		$monetizecontact_background_color = $this->common->nohtml($this->input->post("monetizecontact_background_color"));
		$monetizecontact_redirect = $this->common->nohtml($this->input->post("monetizecontact_redirect"));
		...
		$this->user_model->save_customization($lead_sms_template,$charge_sms_template,$header_color,$button_color,$button_hover_color,$button_border_color,$monetizecontact_background_color,$monetizecontact_redirect,$lead_cost,$lead_rate_limit);
