...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_191") ?></td><td><?php echo lang("ctn_29") ?></td><td><?php echo lang("ctn_30") ?></td><td>Phone</td><td><?php echo lang("ctn_78") ?></td><td><?php echo lang("ctn_322") ?></td><td><?php echo lang("ctn_194") ?></td><td><?php echo lang("ctn_195") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
				  ...
				  <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="phone-in" name="phone_no">
                        </div>
                </div>
                <div class="form-group">
