...
<h4 class="home-label">Historical Lead Accept Volume</h4>
...
<hr>
<div class="col-md-12">
<h4 class="home-label">Leads Accepted</h1>
...
//echo "<pre>";print_r($r);echo "</pre>";//die('test');
?>
