           ...
           ($this->user->info->admin || $this->user->info->admin_settings || $this->user->info->admin_members || $this->user->info->admin_payment)
			...
			<?php if($this->user->info->admin) : ?>
			  <li class="<?php if(isset($activeLink['leads']['general'])) echo "active" ?>"><a href="<?php echo site_url("leads") ?>"><span class="glyphicon glyphicon-signal sidebar-icon"></span> Leads </a></li>
                          <li class="<?php if(isset($activeLink['types']['general'])) echo "active" ?>"><a href="<?php echo site_url("leads/types") ?>"><span class="glyphicon glyphicon-usd sidebar-icon"></span> Lead Types </a></li>
			<?php endif;?>
        			<?php if($this->user->info->admin) : ?>
			...
			<?php endif;?>
			<?php if($this->user->info->admin) : ?>
			  <li class="<?php if(isset($activeLink['support']['general'])) echo "active" ?>"><a href="https://monetizelead.com/blog"><span class="glyphicon glyphicon-cloud sidebar-icon"></span> Support Desk </a></li>
			<?php endif;?>
			<?php if($this->user->info->admin) { ?>
