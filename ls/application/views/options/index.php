  	...
  	<?php echo form_open(site_url("Options/save"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
			    ...
			    <div class="col-sm-6">
				  ...
				  <em>You can change the text and re-postion the variables(delimited by '|' symbol). But you can't add any new variable.You can use the follow variables for charge sms template. <br>|username|<br>|leadname|<br>|leademail|<br>|leadphone|<br>|leadzipcode|<br>|leadurl|<br>|teamurl|</em><br><em>|notes|</em>	 				 
			    </div>				
			</div>
			<div class="form-group">
			    ...
			    <div class="col-sm-6">
				  ...
				  <em>You can change the text and re-postion the variables(delimited by '|' symbol). But you can't add any new variable. You can use the follow variables for charge sms template. <br>|username|<br>|leadname|<br>|email|<br>|phone|<br>|token|<br>|click_hash|<br>|affilate_id|</em><br>	
